...
$conectar =conectar();
$select="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(1)";
$select1="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(2)";
$select2="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(3)";
$select3="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(4)";
$select4="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(5)";
$select5="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(6)";
$select6="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(7)";
$select7="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(8)";
$select8="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(9)";
$select9="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(10)";
$select10="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(11)";
$select11="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(12)";
$select12="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(13)";
$select13="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(14)";
$select14="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(15)";
$select15="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(16)";
$select16="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(17)";
$select17="SELECT id_producto,precio,cantidad_disponible,nombre_p,tipo_prod,peso,descripcion FROM produpasteles WHERE id_producto=(18)";
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p><b>Peso:</b><?php  echo $precio3?> gramos</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p><b>Cantidad disponible:</b><?php  echo $descripcion6?></p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                  </div>
                </div>
